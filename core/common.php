...
/**
* Create iframe's from youtube links
* @return string
* @param string $sContent
*/
function changeYoutubeLinks( $sContent ){
  return preg_replace( '/(http[s]*'.preg_quote( '://www.youtube.com/watch?v=', '/' ).'|http[s]*'.preg_quote( '://youtu.be/', '/' ).')([a-zA-Z0-9_-]+)'.'/', '<iframe class="youtube" src="//www.youtube.com/embed/\\2"allowfullscreen></iframe>', $sContent );
} // end function changeYoutubeLinks
